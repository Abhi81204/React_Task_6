    ...
    return (
        <div name="About" className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                Hello! Abhiram Rayidi here, a third-year Computer Science and Engineering student Specializing in AI and ML at VIT - AP Amaravati. Passionate about technology, I'm determined to excel in the computer science field. Actively pursuing internships and work opportunities in dynamic settings to apply and enhance my skills. Eager to upskill in new technologies and constantly seeking to broaden my knowledge. Open to learning and growth.
                </p>
                <br />
